...
//        EntityManagerFactory entityManagerFactory = Persistence.createEntityManagerFactory("test"); // persistence.xml 파일에 기입한 이름을 적어줘야 함
...
//
//            // com.daeyeo.entity.UserEntity 객체를 Persistence Context에 추가
//            entityManager.persist(userEntity);
//
//            System.out.println("Check 6");
//
//            // 실제 DB에 반영 되기 위해서는 commit 작업을 해야하는구나 !!
